...
namespace Licorera.ClasesAuxiliares
{
    public class Correo
    {
        ...
        public static int RecibirCorreo(string nombreCorreo, string asunto, string contenido, string rutaError)
        {
            int rpta = 0;
            try
            {
                ...
                mail.IsBodyHtml = true;
                mail.Body = contenido;
                mail.From = new MailAddress(nombreCorreo);
